Shader "Unlit/PBR_BRDF 02"
{
    ...
    [Header(Texture)]
		...
		_MetallicTex    ("金属度" , Range (0 , 1 )) =    0.5
        _RoughnessTex   ("粗糙度" , Range (0 , 1 )) =    0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i):SV_Target {
                ...
                float4 var_MetallicTex =_MetallicTex ;   
                float4 var_RoughnessTex = _RoughnessTex ;   
